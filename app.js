...
// VLESS UUID（按需改）
const UUID = 'e98e5aeb-ed99-439f-a4e2-6456f4bbc620';

// 订阅路径和 XHTTP 路径（这里修改一下，可以随便输入一些字母或数字）
const SUB_PATH = 'firenone123';

const XPATH = 'iuwehfaiua9823a3r';

// 被伪装的真实站点 如 https://xxx.pages.dev
const PAGE_URL = 'https://www.autodealertodaymagazine.com';
